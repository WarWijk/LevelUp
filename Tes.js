...
(lib.Kotak = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,1,1).p("AxBogMAiDAAAIAARBMgiDAAAg");

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#006600").s().p("AxBIhIAAxBMAiDAAAIAARBg");

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Kotak, new cjs.Rectangle(-110,-55.5,220,111), null);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		*/
		...
		Kotak.addEventListener(MouseEvent.MOUSE_DOWN, fl_ClickToDrag_3);
	...
	// Kotak
	this.Kotak = new lib.Kotak();
	this.Kotak.name = "Kotak";
	this.Kotak.setTransform(636.9,381.9);

	this.timeline.addTween(cjs.Tween.get(this.Kotak).wait(449).to({x:611.9,y:337.45},0).wait(1));
